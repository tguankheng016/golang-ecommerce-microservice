...
func MapRoute(echo *echo.Echo, jwtTokenGenerator services.IJwtTokenGenerator) {
	group := echo.Group("/api/v1/identities/sign-out")
...
// @Success 200
// @Security ApiKeyAuth
// @Router /api/v1/identities/sign-out [post]
func signOut(jwtTokenGenerator services.IJwtTokenGenerator) echo.HandlerFunc {
